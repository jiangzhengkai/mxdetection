...
static const char __pyx_k_data_zhengkai_jiang_DETECTION_M[] = "/data/zhengkai.jiang/DETECTION_MXNET/mxnet-detection/mxdetection/ops/cython/gpu_mv.pyx";
 ...
 */
  ...
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(9, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_data_zhengkai_jiang_DETECTION_M, __pyx_n_s_mv, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
